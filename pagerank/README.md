...
One specific bug I fought: dealing with "sink" pages (pages with no outgoing links). If you aren't careful, the probability mass just disappears into a black hole. I had to treat those pages as if they linked to *every* page efficiently. I was very excited to implement the algorithm which acts as a basis of our beloved **Google** seatch engine.
