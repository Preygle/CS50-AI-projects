...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # If parents exist, calculate conditional probability
        else:
            # Probabilities of passing the gene from mother and father
            pass_prob = {}
            ...
            # Calculate probability of child's number of genes
            if num_genes == 0:
                person_prob *= (1 - pass_prob[mother]) * (1 - pass_prob[father])
            elif num_genes == 1:
                person_prob *= pass_prob[mother] * (1 - pass_prob[father]) + (1 - pass_prob[mother]) * pass_prob[father]
            else: # num_genes == 2
                person_prob *= pass_prob[mother] * pass_prob[father]

        # Multiply by the probability of having the trait given the number of genes
